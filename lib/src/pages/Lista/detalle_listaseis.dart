...
class DetalleListaSeis extends StatefulWidget {

  
  final TodoSeis textoLetra;

  final TituloSeis titulo;

  DetalleListaSeis ({this.textoLetra, this.titulo });

  @override
  _DetalleListaState createState() => _DetalleListaState();
}

class _DetalleListaState extends State<DetalleListaSeis> {
