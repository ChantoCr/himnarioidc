...
import 'package:disenos/src/pages/Lista/detalle_lista.dart';
...
class PrimerLista extends StatelessWidget {
  ...
  data.forEach((opt){
    ...
    final widgetTemp = ListTile(
      ...
      onTap: () {
        ...
        final textoLetra = Todo((opt["letra"]));

        final titulo = Titulo((opt["texto"]));
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => DetalleLista(textoLetra: textoLetra,titulo : titulo)
          )
        );   
      }, 
