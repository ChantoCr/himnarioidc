...
import 'package:disenos/src/pages/Lista/detalle_listaseis.dart';
...
class TituloSeis {
  ...
  TituloSeis(this.titles);
  
}



class SextaLista extends StatelessWidget {
  ...
  Widget _lista(){
    ...
    return FutureBuilder(
      future: menuProvider.cargarDataSeis(),
      initialData: [],
  ...
  data.forEach((opt){
    ...
    final widgetTemp = ListTile(
      ...
      onTap: () {
        ...
        final textoLetra = TodoSeis((opt["letra"]));

        final titulo = TituloSeis((opt["texto"]));
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => DetalleListaSeis(textoLetra: textoLetra,titulo : titulo)
          )
        );   
      }, 
