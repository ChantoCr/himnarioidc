...
class DetalleListaOcho extends StatefulWidget {

  
  final TodoOcho textoLetra;

  final TituloOcho titulo;

  DetalleListaOcho ({this.textoLetra, this.titulo });

  @override
  _DetalleListaState createState() => _DetalleListaState();
}

class _DetalleListaState extends State<DetalleListaOcho> {
